...
public class VerifyUserDefinedDataTests {
	...
	@Test
	public void simpleFieldHasUnsupportedType() throws SAXException, IOException {
		thrown.expect(AssertionError.class);
		thrown.expectMessage("kml:SimpleField[@name=\"date\"] has an unsupported @type attribute value.");
		URL url = this.getClass().getResource("/kml/custom/SimpleField-UnsupportedType.xml");
		Document doc = docBuilder.parse(url.toString());
		UserDefinedDataTests iut = new UserDefinedDataTests();
		iut.setTestSubject(doc);
		iut.verifySimpleField();
	...
	public void schemaDataWithValidRemoteSchemaRef() throws SAXException, IOException {
		URL url = this.getClass().getResource("/kml/custom/SchemaData-RemoteSchema.xml");
		Document doc = docBuilder.parse(url.toString());
		UserDefinedDataTests iut = new UserDefinedDataTests();
		iut.setTestSubject(doc);
		iut.verifySchemaData();
	...
	@Test
	public void schemaDataWithInvalidSchemaRef() throws SAXException, IOException {
		thrown.expect(AssertionError.class);
		thrown.expectMessage("kml:SchemaData references a kml:Schema element that cannot be found");
		URL url = this.getClass().getResource("/kml/custom/SchemaData-NoSchema.xml");
		Document doc = docBuilder.parse(url.toString());
		UserDefinedDataTests iut = new UserDefinedDataTests();
		iut.setTestSubject(doc);
		iut.verifySchemaData();
	...
	public void schemaDataWithInvalidDatum() throws SAXException, IOException {
		...
		URL url = this.getClass().getResource("/kml/custom/SchemaData-InvalidDatum.xml");
		Document doc = docBuilder.parse(url.toString());
		UserDefinedDataTests iut = new UserDefinedDataTests();
		iut.setTestSubject(doc);
		iut.verifySchemaData();
	...
	@Test
	public void untypedDataOk() throws SAXException, IOException, XPathExpressionException {
	...
	@Test
	public void untypedDataNotUnique() throws SAXException, IOException, XPathExpressionException {
		thrown.expect(AssertionError.class);

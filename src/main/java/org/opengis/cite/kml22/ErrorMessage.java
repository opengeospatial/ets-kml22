...
public class ErrorMessage {
	...
	private static final String BASE_NAME = "org.opengis.cite.kml22.MessageBundle";
	 ...
	 * @param msgKey A String identifying the message template; it should be a member of
